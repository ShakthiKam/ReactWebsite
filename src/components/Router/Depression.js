          ...
          <div className="container main-content">
            <div className="row">
              ...
              <div className="col-12">
                <h4 className="text-center hero-title mb-4" style={{fontSize: "2rem",fontWeight: 500,marginLeft:"10px"}}>Depression</h4>
                <p className="title-desc" style={{color:"#FFFFFF"}}>Depression is defined as a condition where a person experiences discouragement, sadness, hopelessness, and disinterest.</p>
                <p className="title-desc" style={{color:"#FFFFFF"}}>A person with depression is unmotivated by life in general. When the feelings are experienced for a short period of time, then depression falls under the “case of the blues.”</p>
                <p className="title-desc" style={{color:"#FFFFFF"}}>However, when these feelings are experienced for a longer period of time, for example more than two weeks, and the feelings interfere with normal, daily activities such as taking care of family, going to work or school, and spending time with friends, then the experience is likely a depressive episode.</p>
                <p className="title-desc" style={{color:"#FFFFFF"}}>Depression, even major depression, is treatable, because as an illness, it affects the way in which a person feels, behaves, thinks, and functions.</p>
                <p className="title-desc" style={{color:"#FFFFFF"}}>All depression and anxiety disorders are not equal. One person’s experience with depression is not the same as another person’s experience with an anxiety disorder.
                </p>
                <p className="title-desc" style={{color:"#FFFFFF"}}>Each person with their respective condition experiences similar symptoms such as nervousness, problems with sleeping and concentrating, and irritability. However, each disorder has its own causes and symptoms.</p>
              </div>
            </div>  
            <div className="row">
              <div className="col-12 pt-4">
                ...
                <div className="text-center mb-2">
                  <a className="title-desc self-care-link" href="#" onClick ={() => {history.push("/selfcare");}} style={{color:"#fff"}}>Explore more self-care activities here</a>
                </div>
                <div className="hr-line" />
              </div>
            </div>
                ...
                <div className="col-lg-3 col-md-2 col-sm-3 col-6 links-container">
                  <div className="condition-links">
                    ...
                    <ul className="footer-links-list" style={{marginLeft:"-35px",cursor: "pointer",marginTop:"-25px"}}>
                      <li><a href="#"  style={{color:"#C5C5C5",lineHeight:1.5,textDecorationLine:"none",fontFamily: 'Roboto',fontWeight: 400,fontSize:16}}>Feeling Sad </a></li>
