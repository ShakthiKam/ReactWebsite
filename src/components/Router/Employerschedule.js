    ...
    <div className="container">
      <div className="row">
        <div className="col-12 return-link-container">
          ...
          <h4 className="sub-title black-text" style={{fontSize: "2rem"}}>Schedule your consultation</h4>
        </div>
      </div>
    </div>
    {/* End of Return-link */}
        ...
        <div className="col-lg-8 col-md-7">
          ...
          <form action="#" className="availabelity">
            ...
            <div className="text-center shedule-bnt-wrapper">
              <button type="button" id="schedule-appointment" onClick ={() => {history.push("/employerform");}}>Schedule appointment</button>
            </div>
          </form>
        </div>
      </div>
