            ...
            <div className="container">
              <div className="row">
                <div className="col-12 return-link-container">
                  ...
                  <h4 className="sub-title black-text">Schedule your first online counseling session</h4>
                </div>
              </div>
            </div>
            {/* End of Return-link */}
                ...
                <div className="col-lg-8 col-md-7">
                  ...
                  <div className="availabelity">
                    ...
                    <div className="text-center shedule-bnt-wrapper">
                      <button type="button" onclick="window.location= './enroll-confirmation.html'">Schedule appointment</button>
                    </div>
                  </div>
                </div>
              </div>
