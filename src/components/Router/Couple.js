              ...
              <div className="row">
                ...
                <div className="col-lg-4 col-md-8 col-sm-10 individual-content">
                  <div className="hero-text-container">
                    <h1 className="hero-title" style={{marginLeft:"5px",lineHeight:2,marginTop:"-25px",fontWeight:400}}>Welcome</h1>
                  ...
                  <div className="checkbox-container">
                    <ul className="checkbox-lists" style={{marginLeft:"-10px", fontSize:18, marginTop:"-5px"}}> 
                      {/* link 1 */}
              ...
              <div className="row">
                ...
                <div className="col-lg-4 col-md-6 col-8">
                  <div className="linear-btn-container">
                    <button  style={{marginLeft:"5px",backgroundColor:"#d7e0e9a6",cursor:"pointer"}} type="button" className="linear-btn" onClick ={() => {history.push("/aboutapp");}} style={{height:"38px"}}>Continue</button>
                  </div>
                </div>
