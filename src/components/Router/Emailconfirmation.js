        ...
        <div className="container">
          <div className="row">
            <div className="col-12 return-link-container">
              ...
              <h4 className="sub-title black-text" style={{fontSize: "2rem",fontWeight: 500}}>Email confirmation</h4>
            </div>
          </div>
        </div>
        {/* End of Return-link */}
