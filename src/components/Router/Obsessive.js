            ...
            <div className="container">
              <div className="row">
                ...
                <div className="col-12 copyrights">
                  <p>If you feel you are in crisis, don't use this site. Call 911, or 1.800.273 TALK (8255). <span className="additionl-resource"><a href="./../resources/resources.html" className="underline-link">Resources.</a></span></p>
