              ...
              <div className="container">
                <div className="row">
                  <div className="col-12 header-content">
                    <div className="logo">
                      <h4 style={{color:"#fff",marginTop:"10px",cursor:"pointer"}}>Wellness</h4></div>
            ...
            <div className="container main-content">
              <div className="row">
                ...
                <div className="col-12 btns-container">
                  <ul className="list" style={{marginLeft:"4px",marginTop:"-20px"}}>
                    {/* Link 1 */}
            ...
            <div className="container">
              <div className="row">
                ...
                <div className="col-lg-2 col-md-3 col-sm-3 col-6 links-container">
                  ...
                  <ul className="footer-links-list" style={{marginLeft:"-33px",cursor: "pointer",marginTop:"-23px"}}>
                ...
                <div className="col-lg-3 col-md-2 col-sm-3 col-6 links-container">
                  <div className="condition-links">
                    ...
                    <ul className="footer-links-list" style={{marginLeft:"-35px",cursor: "pointer",marginTop:"-23px"}}>
